      ...
      <div className="w-full max-w-md my-auto">
        <div className="rounded-lg p-4 sm:p-8 bg-card border border-border shadow-elevated">
          ...
          <div className="flex justify-center mb-4 sm:mb-6">
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg bg-gradient-to-br from-green-500/20 to-green-500/5 border border-green-500/20 flex items-center justify-center">
          ...
          <div className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 rounded-lg bg-destructive/10 border border-destructive/20 mb-4 sm:mb-6">
            ...
            <div className="text-xs sm:text-sm text-destructive">
              ...
              <p>
                ...
                way to recover your vault if you forget your password.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <span className="text-xs sm:text-sm text-muted-foreground">
              I have saved my new recovery key. I understand that my old
              recovery key is now invalid.
            </span>
          </label>
